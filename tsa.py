...
if len(sys.argv) == 7:
    ...
    if sys.argv[1] == 'connect':
        out_file += 'connect'
        completeSingle(filename, type, ini_mapping_path,'QX20')
    ...
    fu = FileUtils()
    fileResult = fu.readQasm(path=current_path,position=20)
    ...
    initial_mapping = get_initial_gql(ss, 'QX20', ini_mapping_path)
